...
public final class add_proc_byte extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new add_proc_byte(op1, op2);
    }
  }
  ...
  public add_proc_byte(final Immediate op1, final Immediate op2) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    vars__.tmpb_res.access().store(Data.zeroExtend(Type.CARD(9), op1.access().load()).add(Data.zeroExtend(Type.CARD(9), op2.access().load())));
    pe__.OF.access().store(Data.valueOf(BIT, op1.access().bitField(7, 7).load().equals(op2.access().bitField(7, 7).load()) && !op1.access().bitField(7, 7).load().equals(vars__.tmpb_res.access().bitField(7, 7).load())));
