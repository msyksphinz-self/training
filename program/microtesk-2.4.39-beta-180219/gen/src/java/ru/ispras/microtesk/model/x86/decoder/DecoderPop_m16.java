...
import ru.ispras.microtesk.model.x86.op.pop_m16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderPop_m16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderPop_m16 extends DecoderItem {
  private static DecoderPop_m16 instance = null;

  public static DecoderPop_m16 get() {
    if (null == instance) {
      instance = new DecoderPop_m16();
    }
    return instance;
  }

  private DecoderPop_m16() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11010001111", 2, 11))) {
      return null;
    }
    ...
    return newResult(new pop_m16(seg_ovrd, dst));
  }
}
