...
import ru.ispras.microtesk.model.minimips.op.ori;
import ru.ispras.microtesk.model.minimips.mode.REG;
import ru.ispras.microtesk.model.Immediate;

/**
 * The {@code DecoderOri} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderOri extends DecoderItem {
  private static DecoderOri instance = null;

  public static DecoderOri get() {
    if (null == instance) {
      instance = new DecoderOri();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("001101", 2, 6))) {
      return null;
    }
    ...
    return newResult(new ori(rt, rs, imm));
  }
}
