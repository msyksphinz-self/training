...
import ru.ispras.microtesk.model.x86.op.and_r8i8;
import ru.ispras.microtesk.model.x86.mode.R8;
import ru.ispras.microtesk.model.x86.mode.IMM8;

/**
 * The {@code DecoderAnd_r8i8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderAnd_r8i8 extends DecoderItem {
  private static DecoderAnd_r8i8 instance = null;

  public static DecoderAnd_r8i8 get() {
    if (null == instance) {
      instance = new DecoderAnd_r8i8();
    }
    return instance;
  }

  private DecoderAnd_r8i8() {
    super(
        24,
        true,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new and_r8i8(op1, op2));
  }
}
