...
public final class imul_r16 extends IsaPrimitive {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    vars__.tmpdw_op1.access().store(Data.signExtend(DWORD, Data.cast(SWORD, pe__.AX.access().load())).multiply(Data.signExtend(DWORD, Data.cast(SWORD, op1.access(pe__, vars__).load()))));
