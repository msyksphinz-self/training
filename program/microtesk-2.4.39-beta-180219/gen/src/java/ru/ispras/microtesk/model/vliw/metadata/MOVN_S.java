...
/**
 * The {@code MOVN_S} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class MOVN_S extends MetaOperation {
  private static MOVN_S instance = null;

  public static MOVN_S get() {
    if (null == instance) {
      instance = new MOVN_S();
    }
    return instance;
