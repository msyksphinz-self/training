...
public final class imul_m16 extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new imul_m16(seg_ovrd, op1);
    }
  }
  ...
  public imul_m16(final RSEG16 seg_ovrd, final IsaPrimitive op1) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    vars__.tmpdw_op1.access().store(Data.signExtend(DWORD, Data.cast(SWORD, pe__.AX.access().load())).multiply(Data.signExtend(DWORD, Data.cast(SWORD, Location.concat(pe__.MEM.access(vars__.base.access().load().add(op1.access(pe__, vars__).load()).add(Data.valueOf(addR, 0x1))), pe__.MEM.access(vars__.base.access().load().add(op1.access(pe__, vars__).load()))).load()))));
    ...
    if ((pe__.DX.access().load().equals(Data.valueOf(WORD, 0x0)) || pe__.DX.access().load().equals(Data.valueOf(WORD, 0xff)))) {
