...
import ru.ispras.microtesk.model.x86.op.xor_r8m8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.x86.mode.R8;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderXor_r8m8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderXor_r8m8 extends DecoderItem {
  private static DecoderXor_r8m8 instance = null;

  public static DecoderXor_r8m8 get() {
    if (null == instance) {
      instance = new DecoderXor_r8m8();
    }
    return instance;
  }

  private DecoderXor_r8m8() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11000110010", 2, 11))) {
      return null;
    }
    ...
    return newResult(new xor_r8m8(seg_ovrd, op1, op2));
  }
}
