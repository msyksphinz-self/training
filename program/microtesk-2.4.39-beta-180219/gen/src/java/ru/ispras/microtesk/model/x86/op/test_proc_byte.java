...
public final class test_proc_byte extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    Info() {
      super(
          IsaPrimitiveKind.OP,
          "test_proc_byte",
          test_proc_byte.class,
          null
          );
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new test_proc_byte(op1, op2);
    }
  }
  ...
  public test_proc_byte(final Immediate op1, final Immediate op2) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    vars__.tmpb_res.access().store(Data.zeroExtend(Type.CARD(9), op1.access().load().and(op2.access().load())));
