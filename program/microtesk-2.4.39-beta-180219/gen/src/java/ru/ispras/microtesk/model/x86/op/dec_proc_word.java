...
public final class dec_proc_word extends IsaPrimitive {
  ...
  public dec_proc_word(final Immediate op1) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    vars__.tmpw_res.access().store(Data.zeroExtend(Type.CARD(17), op1.access().load().subtract(Data.valueOf(WORD, 0x1))));
