...
public final class bltzal extends IsaPrimitive {
  ...
  public bltzal(final REG rs, final IsaPrimitive offset) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    ...
    return String.format("bltzal %s, %s", rs.text(vars__), offset.text(vars__));
  }

  @Override
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    return String.format("000001%s10000%s", rs.image(vars__), offset.image(vars__));
  }
