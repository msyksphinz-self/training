...
import ru.ispras.microtesk.model.x86.op.xchg_r8m8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.x86.mode.R8;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderXchg_r8m8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderXchg_r8m8 extends DecoderItem {
  private static DecoderXchg_r8m8 instance = null;

  public static DecoderXchg_r8m8 get() {
    if (null == instance) {
      instance = new DecoderXchg_r8m8();
    }
    return instance;
  }

  private DecoderXchg_r8m8() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11010000110", 2, 11))) {
      return null;
    }
    ...
    return newResult(new xchg_r8m8(seg_ovrd, dst, src));
  }
}
