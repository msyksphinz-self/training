...
/**
 * The {@code MOVF_S} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class MOVF_S extends MetaOperation {
  private static MOVF_S instance = null;

  public static MOVF_S get() {
    if (null == instance) {
      instance = new MOVF_S();
    }
    return instance;
