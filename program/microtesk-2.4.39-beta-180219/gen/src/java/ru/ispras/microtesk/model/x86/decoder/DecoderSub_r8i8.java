...
import ru.ispras.microtesk.model.x86.op.sub_r8i8;
import ru.ispras.microtesk.model.x86.mode.R8;
import ru.ispras.microtesk.model.x86.mode.IMM8;

/**
 * The {@code DecoderSub_r8i8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSub_r8i8 extends DecoderItem {
  private static DecoderSub_r8i8 instance = null;

  public static DecoderSub_r8i8 get() {
    if (null == instance) {
      instance = new DecoderSub_r8i8();
    }
    return instance;
  }

  private DecoderSub_r8i8() {
    super(
        24,
        true,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new sub_r8i8(op1, op2));
  }
}
