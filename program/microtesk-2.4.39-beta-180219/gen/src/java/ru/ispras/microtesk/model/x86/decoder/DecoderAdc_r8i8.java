...
import ru.ispras.microtesk.model.x86.op.adc_r8i8;
import ru.ispras.microtesk.model.x86.mode.R8;
import ru.ispras.microtesk.model.x86.mode.IMM8;

/**
 * The {@code DecoderAdc_r8i8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderAdc_r8i8 extends DecoderItem {
  private static DecoderAdc_r8i8 instance = null;

  public static DecoderAdc_r8i8 get() {
    if (null == instance) {
      instance = new DecoderAdc_r8i8();
    }
    return instance;
  }

  private DecoderAdc_r8i8() {
    super(
        24,
        true,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new adc_r8i8(op1, op2));
  }
}
