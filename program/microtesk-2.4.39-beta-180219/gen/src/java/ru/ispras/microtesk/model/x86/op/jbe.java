...
public final class jbe extends IsaPrimitive {
  ...
  public jbe(final Immediate rel) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("jbe <label>%d", rel.access().load().bigIntegerValue());
  }
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("01110110%s", rel.access().load().toString());
  }
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    if (pe__.CF.access().load().equals(Data.valueOf(BIT, 0x1)) && pe__.ZF.access().load().equals(Data.valueOf(BIT, 0x1))) {
