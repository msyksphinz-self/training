...
import ru.ispras.microtesk.model.x86.op.test_m8i8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;
import ru.ispras.microtesk.model.x86.mode.IMM8;

/**
 * The {@code DecoderTest_m8i8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderTest_m8i8 extends DecoderItem {
  private static DecoderTest_m8i8 instance = null;

  public static DecoderTest_m8i8 get() {
    if (null == instance) {
      instance = new DecoderTest_m8i8();
    }
    return instance;
  }

  private DecoderTest_m8i8() {
    super(
        49,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11011110110", 2, 11))) {
      return null;
    }
    ...
    return newResult(new test_m8i8(seg_ovrd, op1, op2));
  }
}
