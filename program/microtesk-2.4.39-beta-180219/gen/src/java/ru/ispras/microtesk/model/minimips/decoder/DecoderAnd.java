...
import ru.ispras.microtesk.model.minimips.op.and;
 ...
 */
public final class DecoderAnd extends DecoderItem {
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("00000100100", 2, 11))) {
      return null;
    }

    return newResult(new and(rd, rs, rt));
  }
}
