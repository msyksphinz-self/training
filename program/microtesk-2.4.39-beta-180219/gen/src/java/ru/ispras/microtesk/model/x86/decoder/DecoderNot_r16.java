...
import ru.ispras.microtesk.model.x86.op.not_r16;
import ru.ispras.microtesk.model.x86.mode.R16;

/**
 * The {@code DecoderNot_r16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderNot_r16 extends DecoderItem {
  private static DecoderNot_r16 instance = null;

  public static DecoderNot_r16 get() {
    if (null == instance) {
      instance = new DecoderNot_r16();
    }
    return instance;
  }

  private DecoderNot_r16() {
    super(
        16,
        true,
        "1111011111000000",
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new not_r16(op1));
  }
}
