...
public final class bltz extends IsaPrimitive {
  ...
  public bltz(final REG rs, final IsaPrimitive offset) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    ...
    return String.format("bltz %s, %s", rs.text(vars__), offset.text(vars__));
  }

  @Override
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    return String.format("000001%s00000%s", rs.image(vars__), offset.image(vars__));
  }
