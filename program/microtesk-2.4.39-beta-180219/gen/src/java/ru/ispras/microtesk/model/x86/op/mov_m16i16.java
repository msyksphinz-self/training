...
public final class mov_m16i16 extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new mov_m16i16(seg_ovrd, dst, src);
    }
  }
  ...
  public mov_m16i16(final RSEG16 seg_ovrd, final IsaPrimitive dst, final IMM16 src) {
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("001%s11011000111%s001%s%s%s", seg_ovrd.image(vars__), vars__.mod.access().load().toString(), vars__.rm.access().load().toString(), dst.image(vars__), src.image(vars__));
  }
