...
import ru.ispras.microtesk.model.x86.op.sbb_r16i16;
import ru.ispras.microtesk.model.x86.mode.R16;
import ru.ispras.microtesk.model.x86.mode.IMM16;

/**
 * The {@code DecoderSbb_r16i16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSbb_r16i16 extends DecoderItem {
  private static DecoderSbb_r16i16 instance = null;

  public static DecoderSbb_r16i16 get() {
    if (null == instance) {
      instance = new DecoderSbb_r16i16();
    }
    return instance;
  }

  private DecoderSbb_r16i16() {
    super(
        32,
        true,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new sbb_r16i16(op1, op2));
  }
}
