...
import ru.ispras.microtesk.model.vmem.op.ml;
import ru.ispras.microtesk.model.vmem.mode.REG;
import ru.ispras.microtesk.model.Immediate;

/**
 * The {@code DecoderMl} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderMl extends DecoderItem {
  private static DecoderMl instance = null;

  public static DecoderMl get() {
    if (null == instance) {
      instance = new DecoderMl();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("0001", 2, 4))) {
      return null;
    }
