...
import ru.ispras.microtesk.model.minimips.op.sltu;
import ru.ispras.microtesk.model.minimips.mode.REG;

/**
 * The {@code DecoderSltu} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSltu extends DecoderItem {
  private static DecoderSltu instance = null;

  public static DecoderSltu get() {
    if (null == instance) {
      instance = new DecoderSltu();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("00000101011", 2, 11))) {
      return null;
    }

    return newResult(new sltu(rd, rs, rt));
  }
}
