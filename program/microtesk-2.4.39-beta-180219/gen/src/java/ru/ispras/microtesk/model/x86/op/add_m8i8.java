...
public final class add_m8i8 extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new add_m8i8(seg_ovrd, op1, op2);
    }
  }
  ...
  public add_m8i8(final RSEG16 seg_ovrd, final IsaPrimitive op1, final IMM8 op2) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    new add_proc_byte(new Immediate(pe__.MEM.access(vars__.base.access().load().add(op1.access(pe__, vars__).load()))), new Immediate(op2.access(pe__, vars__).load().add(Data.valueOf(BYTE, 0x0)))).execute(pe__, vars__);
