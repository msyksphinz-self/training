...
import ru.ispras.microtesk.model.x86.op.sbb_r16m16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.x86.mode.R16;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderSbb_r16m16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSbb_r16m16 extends DecoderItem {
  private static DecoderSbb_r16m16 instance = null;

  public static DecoderSbb_r16m16 get() {
    if (null == instance) {
      instance = new DecoderSbb_r16m16();
    }
    return instance;
  }

  private DecoderSbb_r16m16() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11000011011", 2, 11))) {
      return null;
    }
    ...
    return newResult(new sbb_r16m16(seg_ovrd, op1, op2));
  }
}
