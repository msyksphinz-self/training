...
import ru.ispras.microtesk.model.x86.op.mul_m16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderMul_m16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderMul_m16 extends DecoderItem {
  private static DecoderMul_m16 instance = null;

  public static DecoderMul_m16 get() {
    if (null == instance) {
      instance = new DecoderMul_m16();
    }
    return instance;
  }

  private DecoderMul_m16() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new mul_m16(seg_ovrd, op1));
  }
}
