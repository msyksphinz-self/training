...
public final class jnae extends IsaPrimitive {
  ...
  public jnae(final Immediate rel) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("jnae <label>%d", rel.access().load().bigIntegerValue());
  }
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("01110010%s", rel.access().load().toString());
  }
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    if (pe__.CF.access().load().equals(Data.valueOf(BIT, 0x1))) {
