...
import ru.ispras.microtesk.model.vliw.op.SUB_S;
import ru.ispras.microtesk.model.vliw.mode.F;

/**
 * The {@code DecoderSUB_S} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSUB_S extends DecoderItem {
  private static DecoderSUB_S instance = null;

  public static DecoderSUB_S get() {
    if (null == instance) {
      instance = new DecoderSUB_S();
    }
    return instance;
  }

  private DecoderSUB_S() {
    super(
        32,
        true,
        "01000110000000000000000000000001",
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new SUB_S(fd, fs, ft));
  }
}
