...
import ru.ispras.microtesk.model.minimips.op.sltiu;
import ru.ispras.microtesk.model.minimips.mode.REG;
import ru.ispras.microtesk.model.Immediate;

/**
 * The {@code DecoderSltiu} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSltiu extends DecoderItem {
  private static DecoderSltiu instance = null;

  public static DecoderSltiu get() {
    if (null == instance) {
      instance = new DecoderSltiu();
    }
    return instance;
  }

  private DecoderSltiu() {
    super(
        32,
        true,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("001011", 2, 6))) {
      return null;
    }
    ...
    return newResult(new sltiu(rt, rs, imm));
  }
}
