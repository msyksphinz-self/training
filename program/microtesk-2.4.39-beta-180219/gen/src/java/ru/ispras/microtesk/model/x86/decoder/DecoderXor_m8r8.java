...
import ru.ispras.microtesk.model.x86.op.xor_m8r8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;
import ru.ispras.microtesk.model.x86.mode.R8;

/**
 * The {@code DecoderXor_m8r8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderXor_m8r8 extends DecoderItem {
  private static DecoderXor_m8r8 instance = null;

  public static DecoderXor_m8r8 get() {
    if (null == instance) {
      instance = new DecoderXor_m8r8();
    }
    return instance;
  }

  private DecoderXor_m8r8() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11000110000", 2, 11))) {
      return null;
    }
    ...
    return newResult(new xor_m8r8(seg_ovrd, op1, op2));
  }
}
