...
public final class adc_m16i16 extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new adc_m16i16(seg_ovrd, op1, op2);
    }
  }
  ...
  public adc_m16i16(final RSEG16 seg_ovrd, final IsaPrimitive op1, final IMM16 op2) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("adc %s:%s, %s", seg_ovrd.text(vars__), op1.text(vars__), op2.text(vars__));
  }
