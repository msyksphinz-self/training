...
import ru.ispras.microtesk.model.x86.op.inc_m8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderInc_m8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderInc_m8 extends DecoderItem {
  private static DecoderInc_m8 instance = null;

  public static DecoderInc_m8 get() {
    if (null == instance) {
      instance = new DecoderInc_m8();
    }
    return instance;
  }

  private DecoderInc_m8() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new inc_m8(seg_ovrd, op1));
  }
}
