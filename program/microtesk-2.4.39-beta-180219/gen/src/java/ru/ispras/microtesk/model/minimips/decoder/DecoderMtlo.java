...
import ru.ispras.microtesk.model.minimips.op.mtlo;
import ru.ispras.microtesk.model.minimips.mode.REG;

/**
 * The {@code DecoderMtlo} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderMtlo extends DecoderItem {
  private static DecoderMtlo instance = null;

  public static DecoderMtlo get() {
    if (null == instance) {
      instance = new DecoderMtlo();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("00000010011", 2, 11))) {
      return null;
    }

    return newResult(new mtlo(rs));
  }
}
