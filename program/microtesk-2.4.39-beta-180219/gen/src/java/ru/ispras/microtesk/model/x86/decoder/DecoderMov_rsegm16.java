...
import ru.ispras.microtesk.model.x86.op.mov_rsegm16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderMov_rsegm16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderMov_rsegm16 extends DecoderItem {
  private static DecoderMov_rsegm16 instance = null;

  public static DecoderMov_rsegm16 get() {
    if (null == instance) {
      instance = new DecoderMov_rsegm16();
    }
    return instance;
  }

  private DecoderMov_rsegm16() {
    super(
        42,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11010001110", 2, 11))) {
      return null;
    }
    ...
    return newResult(new mov_rsegm16(seg_ovrd, dst, src));
  }
}
