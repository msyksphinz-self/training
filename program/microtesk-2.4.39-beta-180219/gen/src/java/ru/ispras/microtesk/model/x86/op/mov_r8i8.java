...
public final class mov_r8i8 extends IsaPrimitive {
  ...
  public mov_r8i8(final R8 dst, final IMM8 src) {
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("10110%s11001%s%s", dst.image(vars__), dst.image(vars__), src.image(vars__));
  }
