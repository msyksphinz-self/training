...
import ru.ispras.microtesk.model.x86.op.add_m16i16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;
import ru.ispras.microtesk.model.x86.mode.IMM16;

/**
 * The {@code DecoderAdd_m16i16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderAdd_m16i16 extends DecoderItem {
  private static DecoderAdd_m16i16 instance = null;

  public static DecoderAdd_m16i16 get() {
    if (null == instance) {
      instance = new DecoderAdd_m16i16();
    }
    return instance;
  }

  private DecoderAdd_m16i16() {
    super(
        57,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new add_m16i16(seg_ovrd, op1, op2));
  }
}
