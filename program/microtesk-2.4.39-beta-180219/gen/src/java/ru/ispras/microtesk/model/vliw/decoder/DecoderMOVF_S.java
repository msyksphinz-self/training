...
import ru.ispras.microtesk.model.vliw.op.MOVF_S;
import ru.ispras.microtesk.model.vliw.mode.F;
import ru.ispras.microtesk.model.Immediate;

/**
 * The {@code DecoderMOVF_S} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderMOVF_S extends DecoderItem {
  private static DecoderMOVF_S instance = null;

  public static DecoderMOVF_S get() {
    if (null == instance) {
      instance = new DecoderMOVF_S();
    }
    return instance;
  }

  private DecoderMOVF_S() {
    super(
        32,
        true,
        "01000110000000000000000000010001",
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new MOVF_S(fd, fs, cc));
  }
}
