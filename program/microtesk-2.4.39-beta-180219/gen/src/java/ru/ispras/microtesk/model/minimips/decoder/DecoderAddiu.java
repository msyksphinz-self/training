...
import ru.ispras.microtesk.model.minimips.op.addiu;
import ru.ispras.microtesk.model.minimips.mode.REG;
import ru.ispras.microtesk.model.Immediate;

/**
 * The {@code DecoderAddiu} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderAddiu extends DecoderItem {
  private static DecoderAddiu instance = null;

  public static DecoderAddiu get() {
    if (null == instance) {
      instance = new DecoderAddiu();
    }
    return instance;
  }

  private DecoderAddiu() {
    super(
        32,
        true,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("001001", 2, 6))) {
      return null;
    }
    ...
    return newResult(new addiu(rt, rs, imm));
  }
}
