...
import ru.ispras.microtesk.model.x86.op.sbb_r8m8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.x86.mode.R8;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderSbb_r8m8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSbb_r8m8 extends DecoderItem {
  private static DecoderSbb_r8m8 instance = null;

  public static DecoderSbb_r8m8 get() {
    if (null == instance) {
      instance = new DecoderSbb_r8m8();
    }
    return instance;
  }

  private DecoderSbb_r8m8() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11000011010", 2, 11))) {
      return null;
    }
    ...
    return newResult(new sbb_r8m8(seg_ovrd, op1, op2));
  }
}
