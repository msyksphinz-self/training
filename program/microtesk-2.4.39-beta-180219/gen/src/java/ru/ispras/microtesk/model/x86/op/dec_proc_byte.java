...
public final class dec_proc_byte extends IsaPrimitive {
  ...
  public dec_proc_byte(final Immediate op1) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    vars__.tmpb_res.access().store(Data.zeroExtend(Type.CARD(9), op1.access().load().subtract(Data.valueOf(BYTE, 0x1))));
    pe__.OF.access().store(Data.valueOf(BIT, op1.access().bitField(7, 7).load().equals(Data.valueOf(Type.CARD(1), 0x0)) && vars__.tmpb_res.access().bitField(7, 7).load().equals(Data.valueOf(Type.CARD(1), 0x1))));
