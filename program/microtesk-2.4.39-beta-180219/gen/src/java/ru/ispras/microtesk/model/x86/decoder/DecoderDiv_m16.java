...
import ru.ispras.microtesk.model.x86.op.div_m16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderDiv_m16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderDiv_m16 extends DecoderItem {
  private static DecoderDiv_m16 instance = null;

  public static DecoderDiv_m16 get() {
    if (null == instance) {
      instance = new DecoderDiv_m16();
    }
    return instance;
  }

  private DecoderDiv_m16() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new div_m16(seg_ovrd, op1));
  }
}
