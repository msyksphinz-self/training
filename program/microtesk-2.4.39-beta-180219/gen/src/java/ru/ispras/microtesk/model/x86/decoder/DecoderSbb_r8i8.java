...
import ru.ispras.microtesk.model.x86.op.sbb_r8i8;
import ru.ispras.microtesk.model.x86.mode.R8;
import ru.ispras.microtesk.model.x86.mode.IMM8;

/**
 * The {@code DecoderSbb_r8i8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSbb_r8i8 extends DecoderItem {
  private static DecoderSbb_r8i8 instance = null;

  public static DecoderSbb_r8i8 get() {
    if (null == instance) {
      instance = new DecoderSbb_r8i8();
    }
    return instance;
  }

  private DecoderSbb_r8i8() {
    super(
        24,
        true,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new sbb_r8i8(op1, op2));
  }
}
