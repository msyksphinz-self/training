...
public final class BIAM_BX_SI extends IsaPrimitive {
  public static final String NAME = "BIAM_BX_SI";
  ...
  public Location access(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    final PE pe__ = (PE) procElem;
    final TempVars vars__ = (TempVars) tempVars;
    return annotate(new Location(Data.signExtend(addR, Data.cast(SWORD, pe__.BX.access().load().add(pe__.SI.access().load())))), vars__);
  }
}