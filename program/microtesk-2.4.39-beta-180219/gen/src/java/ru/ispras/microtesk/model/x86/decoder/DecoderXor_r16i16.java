...
import ru.ispras.microtesk.model.x86.op.xor_r16i16;
import ru.ispras.microtesk.model.x86.mode.R16;
import ru.ispras.microtesk.model.x86.mode.IMM16;

/**
 * The {@code DecoderXor_r16i16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderXor_r16i16 extends DecoderItem {
  private static DecoderXor_r16i16 instance = null;

  public static DecoderXor_r16i16 get() {
    if (null == instance) {
      instance = new DecoderXor_r16i16();
    }
    return instance;
  }

  private DecoderXor_r16i16() {
    super(
        32,
        true,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new xor_r16i16(op1, op2));
  }
}
