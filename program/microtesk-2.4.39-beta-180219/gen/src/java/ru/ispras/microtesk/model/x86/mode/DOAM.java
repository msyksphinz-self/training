...
public final class DOAM extends IsaPrimitive {
  public static final String NAME = "DOAM";
  ...
  public DOAM(final Immediate disp) {
    this.disp = disp;
  ...
  public String syntax(final TemporaryVariables tempVars) {
    ...
    init(vars__);
    return String.format("[%d]", disp.access().load().bigIntegerValue());
  }
  ...
  public Location access(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    final PE pe__ = (PE) procElem;
    final TempVars vars__ = (TempVars) tempVars;
    return annotate(new Location(Data.zeroExtend(addR, disp.access().load())), vars__);
  }
}