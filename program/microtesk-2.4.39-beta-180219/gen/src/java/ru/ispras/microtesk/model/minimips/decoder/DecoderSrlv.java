...
import ru.ispras.microtesk.model.minimips.op.srlv;
import ru.ispras.microtesk.model.minimips.mode.REG;

/**
 * The {@code DecoderSrlv} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSrlv extends DecoderItem {
  private static DecoderSrlv instance = null;

  public static DecoderSrlv get() {
    if (null == instance) {
      instance = new DecoderSrlv();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new srlv(rd, rt, rs));
  }
}
