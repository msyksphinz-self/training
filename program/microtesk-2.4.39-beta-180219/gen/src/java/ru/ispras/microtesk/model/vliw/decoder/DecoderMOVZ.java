...
import ru.ispras.microtesk.model.vliw.op.MOVZ;
import ru.ispras.microtesk.model.vliw.mode.R;

/**
 * The {@code DecoderMOVZ} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderMOVZ extends DecoderItem {
  private static DecoderMOVZ instance = null;

  public static DecoderMOVZ get() {
    if (null == instance) {
      instance = new DecoderMOVZ();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("00000001010", 2, 11))) {
      return null;
    }

    return newResult(new MOVZ(rd, rs, rt));
  }
}
