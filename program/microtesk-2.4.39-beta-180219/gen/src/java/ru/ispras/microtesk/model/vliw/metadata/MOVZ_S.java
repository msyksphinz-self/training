...
/**
 * The {@code MOVZ_S} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class MOVZ_S extends MetaOperation {
  private static MOVZ_S instance = null;

  public static MOVZ_S get() {
    if (null == instance) {
      instance = new MOVZ_S();
    }
    return instance;
