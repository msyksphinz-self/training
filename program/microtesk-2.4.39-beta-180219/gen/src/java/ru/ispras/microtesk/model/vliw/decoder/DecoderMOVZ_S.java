...
import ru.ispras.microtesk.model.vliw.op.MOVZ_S;
import ru.ispras.microtesk.model.vliw.mode.F;
import ru.ispras.microtesk.model.vliw.mode.R;

/**
 * The {@code DecoderMOVZ_S} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderMOVZ_S extends DecoderItem {
  private static DecoderMOVZ_S instance = null;

  public static DecoderMOVZ_S get() {
    if (null == instance) {
      instance = new DecoderMOVZ_S();
    }
    return instance;
  }

  private DecoderMOVZ_S() {
    super(
        32,
        true,
        "01000110000000000000000000010010",
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("010010", 2, 6))) {
      return null;
    }

    return newResult(new MOVZ_S(fd, fs, rt));
  }
}
