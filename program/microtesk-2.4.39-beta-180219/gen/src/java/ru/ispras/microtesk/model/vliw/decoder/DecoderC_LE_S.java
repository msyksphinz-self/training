...
import ru.ispras.microtesk.model.vliw.op.C_LE_S;
import ru.ispras.microtesk.model.vliw.mode.F;
import ru.ispras.microtesk.model.Immediate;

/**
 * The {@code DecoderC_LE_S} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderC_LE_S extends DecoderItem {
  private static DecoderC_LE_S instance = null;

  public static DecoderC_LE_S get() {
    if (null == instance) {
      instance = new DecoderC_LE_S();
    }
    return instance;
  }

  private DecoderC_LE_S() {
    super(
        32,
        true,
        "01000110000000000000000000111110",
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("00111110", 2, 8))) {
      return null;
    }

    return newResult(new C_LE_S(ft, fs, cc));
  }
}
