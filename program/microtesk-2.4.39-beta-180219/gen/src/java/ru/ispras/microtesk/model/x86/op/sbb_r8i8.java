...
public final class sbb_r8i8 extends IsaPrimitive {
  ...
  public sbb_r8i8(final R8 op1, final IMM8 op2) {
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("1000000011000%s%s", op1.image(vars__), op2.image(vars__));
  }
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    new sub_proc_byte(new Immediate(op1.access(pe__, vars__).load().add(Data.valueOf(Type.CARD(8), 0x0))), new Immediate(op2.access(pe__, vars__).load().subtract(Data.zeroExtend(BYTE, pe__.CF.access().load())))).execute(pe__, vars__);
