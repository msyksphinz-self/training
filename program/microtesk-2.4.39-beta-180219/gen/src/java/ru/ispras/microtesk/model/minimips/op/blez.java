...
public final class blez extends IsaPrimitive {
  ...
  public blez(final REG rs, final IsaPrimitive offset) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    ...
    return String.format("blez %s, %s", rs.text(vars__), offset.text(vars__));
  }

  @Override
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    return String.format("000110%s00000%s", rs.image(vars__), offset.image(vars__));
  }
