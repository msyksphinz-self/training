...
public final class BFT extends IsaPrimitive {
  ...
  public BFT(final Immediate cc, final IsaPrimitive offset) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    ...
    return String.format("BFT %d, %s", cc.access().load().bigIntegerValue(), offset.text(vars__));
  }

  @Override
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    return String.format("01000101000%s01%s", cc.access().load().toString(), offset.image(vars__));
  }
