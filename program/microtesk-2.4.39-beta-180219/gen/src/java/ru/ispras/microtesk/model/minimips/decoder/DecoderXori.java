...
import ru.ispras.microtesk.model.minimips.op.xori;
import ru.ispras.microtesk.model.minimips.mode.REG;
import ru.ispras.microtesk.model.Immediate;

/**
 * The {@code DecoderXori} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderXori extends DecoderItem {
  private static DecoderXori instance = null;

  public static DecoderXori get() {
    if (null == instance) {
      instance = new DecoderXori();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("001110", 2, 6))) {
      return null;
    }
    ...
    return newResult(new xori(rt, rs, imm));
  }
}
