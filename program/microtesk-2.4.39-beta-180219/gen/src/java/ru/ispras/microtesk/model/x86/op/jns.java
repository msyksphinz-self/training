...
public final class jns extends IsaPrimitive {
  ...
  public jns(final Immediate rel) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("jns <label>%d", rel.access().load().bigIntegerValue());
  }
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("01111001%s", rel.access().load().toString());
  }
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    if (pe__.SF.access().load().equals(Data.valueOf(BIT, 0x0))) {
