...
public final class and_r16r16 extends IsaPrimitive {
  ...
  public and_r16r16(final R16 op1, final R16 op2) {
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("0010001111%s%s", op1.image(vars__), op2.image(vars__));
  }
