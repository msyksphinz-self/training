...
public final class mul_r8 extends IsaPrimitive {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    pe__.AX.access().store(Data.zeroExtend(WORD, pe__.AL.access().load()).multiply(Data.zeroExtend(WORD, op1.access(pe__, vars__).load())));
