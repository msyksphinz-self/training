...
public final class mov_r16r16 extends IsaPrimitive {
  ...
  public mov_r16r16(final R16 dst, final R16 src) {
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("1000101111%s%s", dst.image(vars__), src.image(vars__));
  }
