...
import ru.ispras.microtesk.model.x86.op.add_r16m16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.x86.mode.R16;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderAdd_r16m16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderAdd_r16m16 extends DecoderItem {
  private static DecoderAdd_r16m16 instance = null;

  public static DecoderAdd_r16m16 get() {
    if (null == instance) {
      instance = new DecoderAdd_r16m16();
    }
    return instance;
  }

  private DecoderAdd_r16m16() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11000000011", 2, 11))) {
      return null;
    }
    ...
    return newResult(new add_r16m16(seg_ovrd, op1, op2));
  }
}
