...
import ru.ispras.microtesk.model.x86.op.div_m8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderDiv_m8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderDiv_m8 extends DecoderItem {
  private static DecoderDiv_m8 instance = null;

  public static DecoderDiv_m8 get() {
    if (null == instance) {
      instance = new DecoderDiv_m8();
    }
    return instance;
  }

  private DecoderDiv_m8() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new div_m8(seg_ovrd, op1));
  }
}
