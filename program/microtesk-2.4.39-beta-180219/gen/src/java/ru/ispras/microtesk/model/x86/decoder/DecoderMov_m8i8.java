...
import ru.ispras.microtesk.model.x86.op.mov_m8i8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;
import ru.ispras.microtesk.model.x86.mode.IMM8;

/**
 * The {@code DecoderMov_m8i8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderMov_m8i8 extends DecoderItem {
  private static DecoderMov_m8i8 instance = null;

  public static DecoderMov_m8i8 get() {
    if (null == instance) {
      instance = new DecoderMov_m8i8();
    }
    return instance;
  }

  private DecoderMov_m8i8() {
    super(
        49,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11011000110", 2, 11))) {
      return null;
    }
    ...
    return newResult(new mov_m8i8(seg_ovrd, dst, src));
  }
}
