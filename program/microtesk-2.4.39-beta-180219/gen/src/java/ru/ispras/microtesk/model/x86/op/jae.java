...
public final class jae extends IsaPrimitive {
  ...
  public jae(final Immediate rel) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("jae <label>%d", rel.access().load().bigIntegerValue());
  }
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    if (pe__.CF.access().load().equals(Data.valueOf(BIT, 0x0))) {
