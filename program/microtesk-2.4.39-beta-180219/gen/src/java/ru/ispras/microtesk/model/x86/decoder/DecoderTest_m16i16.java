...
import ru.ispras.microtesk.model.x86.op.test_m16i16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;
import ru.ispras.microtesk.model.x86.mode.IMM16;

/**
 * The {@code DecoderTest_m16i16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderTest_m16i16 extends DecoderItem {
  private static DecoderTest_m16i16 instance = null;

  public static DecoderTest_m16i16 get() {
    if (null == instance) {
      instance = new DecoderTest_m16i16();
    }
    return instance;
  }

  private DecoderTest_m16i16() {
    super(
        57,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11011110111", 2, 11))) {
      return null;
    }
    ...
    return newResult(new test_m16i16(seg_ovrd, op1, op2));
  }
}
