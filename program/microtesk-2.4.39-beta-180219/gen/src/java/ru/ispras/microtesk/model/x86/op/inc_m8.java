...
public final class inc_m8 extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new inc_m8(seg_ovrd, op1);
    }
  }
  ...
  public inc_m8(final RSEG16 seg_ovrd, final IsaPrimitive op1) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    new inc_proc_byte(new Immediate(pe__.MEM.access(vars__.base.access().load().add(op1.access(pe__, vars__).load())))).execute(pe__, vars__);
