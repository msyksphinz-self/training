...
public final class BIDAM_BX_DI_D16 extends IsaPrimitive {
  public static final String NAME = "BIDAM_BX_DI_D16";
  ...
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new BIDAM_BX_DI_D16(disp);
    }
  }
  ...
  public BIDAM_BX_DI_D16(final Immediate disp) {
    this.disp = disp;
  ...
  public Location access(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    final PE pe__ = (PE) procElem;
    final TempVars vars__ = (TempVars) tempVars;
    return annotate(new Location(Data.signExtend(addR, Data.cast(SWORD, pe__.BX.access().load().add(pe__.DI.access().load()).add(disp.access().load())))), vars__);
  }
}