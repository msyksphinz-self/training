...
import ru.ispras.microtesk.model.minimips.op.blez;
import ru.ispras.microtesk.model.minimips.mode.REG;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderBlez} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderBlez extends DecoderItem {
  private static DecoderBlez instance = null;

  public static DecoderBlez get() {
    if (null == instance) {
      instance = new DecoderBlez();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new blez(rs, offset));
  }
}
