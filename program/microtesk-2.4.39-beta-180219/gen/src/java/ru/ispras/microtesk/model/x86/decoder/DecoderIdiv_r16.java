...
import ru.ispras.microtesk.model.x86.op.idiv_r16;
import ru.ispras.microtesk.model.x86.mode.R16;

/**
 * The {@code DecoderIdiv_r16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderIdiv_r16 extends DecoderItem {
  private static DecoderIdiv_r16 instance = null;

  public static DecoderIdiv_r16 get() {
    if (null == instance) {
      instance = new DecoderIdiv_r16();
    }
    return instance;
  }

  private DecoderIdiv_r16() {
    super(
        16,
        true,
        "1111011111000000",
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new idiv_r16(op1));
  }
}
