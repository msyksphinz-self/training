...
import ru.ispras.microtesk.model.minimips.op.nor;
import ru.ispras.microtesk.model.minimips.mode.REG;

/**
 * The {@code DecoderNor} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderNor extends DecoderItem {
  private static DecoderNor instance = null;

  public static DecoderNor get() {
    if (null == instance) {
      instance = new DecoderNor();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("00000100111", 2, 11))) {
      return null;
    }

    return newResult(new nor(rd, rs, rt));
  }
}
