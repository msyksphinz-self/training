...
public final class xchg_r8r8 extends IsaPrimitive {
  ...
  public xchg_r8r8(final R8 dst, final R8 src) {
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("1000011011%s%s", dst.image(vars__), src.image(vars__));
  }
