...
import ru.ispras.microtesk.model.x86.op.mul_r16;
import ru.ispras.microtesk.model.x86.mode.R16;

/**
 * The {@code DecoderMul_r16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderMul_r16 extends DecoderItem {
  private static DecoderMul_r16 instance = null;

  public static DecoderMul_r16 get() {
    if (null == instance) {
      instance = new DecoderMul_r16();
    }
    return instance;
  }

  private DecoderMul_r16() {
    super(
        16,
        true,
        "1111011111000000",
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new mul_r16(op1));
  }
}
