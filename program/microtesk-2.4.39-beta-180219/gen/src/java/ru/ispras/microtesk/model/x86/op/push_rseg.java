...
public final class push_rseg extends IsaPrimitive {
  ...
  public push_rseg(final RSEG16 src) {
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("000%s110", src.image(vars__));
  }
