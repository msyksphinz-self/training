...
public final class or_proc_byte extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new or_proc_byte(op1, op2);
    }
  }
  ...
  public or_proc_byte(final Immediate op1, final Immediate op2) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    vars__.tmpb_res.access().store(Data.zeroExtend(Type.CARD(9), op1.access().load().or(op2.access().load())));
