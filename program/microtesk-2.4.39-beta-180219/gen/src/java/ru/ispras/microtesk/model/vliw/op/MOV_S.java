...
public final class MOV_S extends IsaPrimitive {
  ...
  public MOV_S(final F fd, final F fs) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    ...
    return String.format("MOV_S %s, %s", fd.text(vars__), fs.text(vars__));
  }

  @Override
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    return String.format("0100011000000000%s%s000110", fs.image(vars__), fd.image(vars__));
  }
