...
import ru.ispras.microtesk.model.x86.op.and_m8i8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;
import ru.ispras.microtesk.model.x86.mode.IMM8;

/**
 * The {@code DecoderAnd_m8i8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderAnd_m8i8 extends DecoderItem {
  private static DecoderAnd_m8i8 instance = null;

  public static DecoderAnd_m8i8 get() {
    if (null == instance) {
      instance = new DecoderAnd_m8i8();
    }
    return instance;
  }

  private DecoderAnd_m8i8() {
    super(
        49,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new and_m8i8(seg_ovrd, op1, op2));
  }
}
