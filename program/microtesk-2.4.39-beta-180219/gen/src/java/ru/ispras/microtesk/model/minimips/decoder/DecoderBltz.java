...
import ru.ispras.microtesk.model.minimips.op.bltz;
import ru.ispras.microtesk.model.minimips.mode.REG;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderBltz} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderBltz extends DecoderItem {
  private static DecoderBltz instance = null;

  public static DecoderBltz get() {
    if (null == instance) {
      instance = new DecoderBltz();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new bltz(rs, offset));
  }
}
