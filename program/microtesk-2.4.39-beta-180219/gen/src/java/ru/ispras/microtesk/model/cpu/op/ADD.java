...
public final class ADD extends IsaPrimitive {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    final TempVars vars__ = (TempVars) tempVars;
    vars__.DEST.access().store(vars__.SRC1.access().load().add(vars__.SRC2.access().load()));
    Execution.trace("%d + %d = %d", vars__.SRC1.access().load().bigIntegerValue(), vars__.SRC2.access().load().bigIntegerValue(), vars__.DEST.access().load().bigIntegerValue());
  }
}