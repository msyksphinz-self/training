...
import ru.ispras.microtesk.model.x86.op.xor_m16r16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;
import ru.ispras.microtesk.model.x86.mode.R16;

/**
 * The {@code DecoderXor_m16r16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderXor_m16r16 extends DecoderItem {
  private static DecoderXor_m16r16 instance = null;

  public static DecoderXor_m16r16 get() {
    if (null == instance) {
      instance = new DecoderXor_m16r16();
    }
    return instance;
  }

  private DecoderXor_m16r16() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new xor_m16r16(seg_ovrd, op1, op2));
  }
}
