...
public final class IAM_SI_D16 extends IsaPrimitive {
  public static final String NAME = "IAM_SI_D16";
  ...
  public IAM_SI_D16(final Immediate disp) {
    this.disp = disp;
  ...
  public Location access(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    final PE pe__ = (PE) procElem;
    final TempVars vars__ = (TempVars) tempVars;
    return annotate(new Location(Data.signExtend(addR, Data.cast(SWORD, pe__.SI.access().load().add(disp.access().load())))), vars__);
  }
}