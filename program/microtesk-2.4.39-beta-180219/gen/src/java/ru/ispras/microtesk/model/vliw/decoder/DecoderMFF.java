...
import ru.ispras.microtesk.model.vliw.op.MFF;
import ru.ispras.microtesk.model.vliw.mode.R;
import ru.ispras.microtesk.model.vliw.mode.F;

/**
 * The {@code DecoderMFF} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderMFF extends DecoderItem {
  private static DecoderMFF instance = null;

  public static DecoderMFF get() {
    if (null == instance) {
      instance = new DecoderMFF();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("01000100000", 2, 11))) {
      return null;
    }
    ...
    return newResult(new MFF(rt, fs));
  }
}
