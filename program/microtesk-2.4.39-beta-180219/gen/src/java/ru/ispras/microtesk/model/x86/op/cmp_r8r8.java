...
public final class cmp_r8r8 extends IsaPrimitive {
  ...
  public cmp_r8r8(final R8 op1, final R8 op2) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("cmp %s, %s", op1.text(vars__), op2.text(vars__));
  }
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("0011100011%s%s", op1.image(vars__), op2.image(vars__));
  }
