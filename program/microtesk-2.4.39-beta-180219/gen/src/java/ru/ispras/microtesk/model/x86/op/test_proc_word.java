...
public final class test_proc_word extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    Info() {
      super(
          IsaPrimitiveKind.OP,
          "test_proc_word",
          test_proc_word.class,
          null
          );
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new test_proc_word(op1, op2);
    }
  }
  ...
  public test_proc_word(final Immediate op1, final Immediate op2) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    vars__.tmpw_res.access().store(Data.zeroExtend(Type.CARD(17), op1.access().load().and(op2.access().load())));
    pe__.CF.access().store(Data.valueOf(BIT, 0x0));
    pe__.OF.access().store(Data.valueOf(BIT, 0x0));
    pe__.SF.access().store(vars__.tmpw_res.access().bitField(15, 15).load());
