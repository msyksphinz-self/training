...
public final class xor_proc_word extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new xor_proc_word(op1, op2);
    }
  }
  ...
  public xor_proc_word(final Immediate op1, final Immediate op2) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    vars__.tmpw_res.access().store(Data.zeroExtend(Type.CARD(17), op1.access().load().xor(op2.access().load())));
