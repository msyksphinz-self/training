...
public final class BIDAM_BP_SI_D8 extends IsaPrimitive {
  public static final String NAME = "BIDAM_BP_SI_D8";
  ...
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new BIDAM_BP_SI_D8(disp);
    }
  }
  ...
  public BIDAM_BP_SI_D8(final Immediate disp) {
    this.disp = disp;
  ...
  public String syntax(final TemporaryVariables tempVars) {
    ...
    init(vars__);
    return String.format("%d[BP+SI]", disp.access().load().bigIntegerValue());
  }
  ...
  public Location access(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    final PE pe__ = (PE) procElem;
    final TempVars vars__ = (TempVars) tempVars;
    return annotate(new Location(Data.signExtend(addR, Data.cast(SWORD, pe__.BP.access().load().add(pe__.SI.access().load()).add(Data.signExtend(WORD, disp.access().load()))))), vars__);
  }
}