...
public final class div_r16 extends IsaPrimitive {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    vars__.tmpdw_op2.access().store(vars__.tmpdw_op1.access().load().divide(Data.zeroExtend(DWORD, op1.access(pe__, vars__).load())));
    ...
    if ((vars__.tmpdw_op1.access().load().compareTo(Data.valueOf(DWORD, 0xffff)) <= 0)) {
      ...
      pe__.DX.access().store(Data.coerce(WORD, vars__.tmpdw_op1.access().load().mod(Data.zeroExtend(DWORD, op1.access(pe__, vars__).load()))));
    }
  }
}