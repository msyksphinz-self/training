...
import ru.ispras.microtesk.model.x86.op.and_m16r16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;
import ru.ispras.microtesk.model.x86.mode.R16;

/**
 * The {@code DecoderAnd_m16r16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderAnd_m16r16 extends DecoderItem {
  private static DecoderAnd_m16r16 instance = null;

  public static DecoderAnd_m16r16 get() {
    if (null == instance) {
      instance = new DecoderAnd_m16r16();
    }
    return instance;
  }

  private DecoderAnd_m16r16() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11000100001", 2, 11))) {
      return null;
    }
    ...
    return newResult(new and_m16r16(seg_ovrd, op1, op2));
  }
}
