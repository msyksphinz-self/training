...
import ru.ispras.microtesk.model.minimips.op.subu;
import ru.ispras.microtesk.model.minimips.mode.REG;

/**
 * The {@code DecoderSubu} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSubu extends DecoderItem {
  private static DecoderSubu instance = null;

  public static DecoderSubu get() {
    if (null == instance) {
      instance = new DecoderSubu();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("00000100011", 2, 11))) {
      return null;
    }

    return newResult(new subu(rd, rs, rt));
  }
}
