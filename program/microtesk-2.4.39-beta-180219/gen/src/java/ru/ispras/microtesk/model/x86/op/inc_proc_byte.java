...
public final class inc_proc_byte extends IsaPrimitive {
  ...
  public inc_proc_byte(final Immediate op1) {
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    vars__.tmpb_res.access().store(Data.zeroExtend(Type.CARD(9), op1.access().load().add(Data.valueOf(BYTE, 0x1))));
