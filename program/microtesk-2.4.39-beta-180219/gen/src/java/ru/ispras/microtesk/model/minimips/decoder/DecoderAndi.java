...
import ru.ispras.microtesk.model.minimips.op.andi;
import ru.ispras.microtesk.model.minimips.mode.REG;
import ru.ispras.microtesk.model.Immediate;

/**
 * The {@code DecoderAndi} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderAndi extends DecoderItem {
  private static DecoderAndi instance = null;

  public static DecoderAndi get() {
    if (null == instance) {
      instance = new DecoderAndi();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("001100", 2, 6))) {
      return null;
    }
    ...
    return newResult(new andi(rt, rs, imm));
  }
}
