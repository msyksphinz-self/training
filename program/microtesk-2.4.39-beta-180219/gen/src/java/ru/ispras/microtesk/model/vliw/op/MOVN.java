...
public final class MOVN extends IsaPrimitive {
  ...
  public MOVN(final R rd, final R rs, final R rt) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    ...
    return String.format("MOVN %s, %s, %s", rd.text(vars__), rs.text(vars__), rt.text(vars__));
  }

  @Override
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    return String.format("000000%s%s%s00000001011", rs.image(vars__), rt.image(vars__), rd.image(vars__));
  }
