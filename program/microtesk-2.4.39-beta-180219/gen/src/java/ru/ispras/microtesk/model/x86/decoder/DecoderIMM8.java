...
/**
 * The {@code DecoderIMM8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderIMM8 extends DecoderItem {
  private static DecoderIMM8 instance = null;

  public static DecoderIMM8 get() {
    if (null == instance) {
      instance = new DecoderIMM8();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    i = readNextImmediate(image, BYTE);

    return newResult(new IMM8(i));
  }
}
