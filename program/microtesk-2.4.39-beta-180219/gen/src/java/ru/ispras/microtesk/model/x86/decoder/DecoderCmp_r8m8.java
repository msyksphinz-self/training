...
import ru.ispras.microtesk.model.x86.op.cmp_r8m8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.x86.mode.R8;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderCmp_r8m8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderCmp_r8m8 extends DecoderItem {
  private static DecoderCmp_r8m8 instance = null;

  public static DecoderCmp_r8m8 get() {
    if (null == instance) {
      instance = new DecoderCmp_r8m8();
    }
    return instance;
  }

  private DecoderCmp_r8m8() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11000111010", 2, 11))) {
      return null;
    }
    ...
    return newResult(new cmp_r8m8(seg_ovrd, op1, op2));
  }
}
