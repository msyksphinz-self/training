...
/**
 * The {@code MOVN} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class MOVN extends MetaOperation {
  private static MOVN instance = null;

  public static MOVN get() {
    if (null == instance) {
      instance = new MOVN();
    }
    return instance;
