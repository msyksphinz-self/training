...
public final class RIAM_DI extends IsaPrimitive {
  public static final String NAME = "RIAM_DI";
  ...
  public Location access(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    final PE pe__ = (PE) procElem;
    final TempVars vars__ = (TempVars) tempVars;
    return annotate(new Location(Data.signExtend(addR, Data.cast(SWORD, pe__.DI.access().load()))), vars__);
  }
}