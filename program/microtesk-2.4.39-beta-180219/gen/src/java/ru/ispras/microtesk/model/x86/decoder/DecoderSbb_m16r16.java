...
import ru.ispras.microtesk.model.x86.op.sbb_m16r16;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;
import ru.ispras.microtesk.model.x86.mode.R16;

/**
 * The {@code DecoderSbb_m16r16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSbb_m16r16 extends DecoderItem {
  private static DecoderSbb_m16r16 instance = null;

  public static DecoderSbb_m16r16 get() {
    if (null == instance) {
      instance = new DecoderSbb_m16r16();
    }
    return instance;
  }

  private DecoderSbb_m16r16() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11000011001", 2, 11))) {
      return null;
    }
    ...
    return newResult(new sbb_m16r16(seg_ovrd, op1, op2));
  }
}
