...
import ru.ispras.microtesk.model.vliw.op.C_EQ_S;
import ru.ispras.microtesk.model.vliw.mode.F;
import ru.ispras.microtesk.model.Immediate;

/**
 * The {@code DecoderC_EQ_S} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderC_EQ_S extends DecoderItem {
  private static DecoderC_EQ_S instance = null;

  public static DecoderC_EQ_S get() {
    if (null == instance) {
      instance = new DecoderC_EQ_S();
    }
    return instance;
  }

  private DecoderC_EQ_S() {
    super(
        32,
        true,
        "01000110000000000000000000110010",
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("00110010", 2, 8))) {
      return null;
    }

    return newResult(new C_EQ_S(ft, fs, cc));
  }
}
