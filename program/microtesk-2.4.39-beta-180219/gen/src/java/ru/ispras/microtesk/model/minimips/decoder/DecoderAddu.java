...
import ru.ispras.microtesk.model.minimips.op.addu;
import ru.ispras.microtesk.model.minimips.mode.REG;

/**
 * The {@code DecoderAddu} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderAddu extends DecoderItem {
  private static DecoderAddu instance = null;

  public static DecoderAddu get() {
    if (null == instance) {
      instance = new DecoderAddu();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new addu(rd, rs, rt));
  }
}
