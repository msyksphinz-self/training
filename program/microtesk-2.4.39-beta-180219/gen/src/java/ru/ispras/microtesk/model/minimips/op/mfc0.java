...
public final class mfc0 extends IsaPrimitive {
  ...
  public mfc0(final REG rt, final RCOP0 cs) {
  ...
  public String syntax(final TemporaryVariables tempVars) {
    ...
    return String.format("mfc0 %s, %s", rt.text(vars__), cs.text(vars__));
  }

  @Override
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    return String.format("01000000000%s%s00000000000", rt.image(vars__), cs.image(vars__));
  }
  ...
  public void action(final ProcessingElement procElem, final TemporaryVariables tempVars) {
    ...
    final TempVars vars__ = (TempVars) tempVars;
    rt.access(pe__, vars__).store(cs.access(pe__, vars__).load());
  }
}