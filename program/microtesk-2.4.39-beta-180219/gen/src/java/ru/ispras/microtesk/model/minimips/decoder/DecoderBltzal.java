...
import ru.ispras.microtesk.model.minimips.op.bltzal;
import ru.ispras.microtesk.model.minimips.mode.REG;
import ru.ispras.microtesk.model.IsaPrimitive;

/**
 * The {@code DecoderBltzal} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderBltzal extends DecoderItem {
  private static DecoderBltzal instance = null;

  public static DecoderBltzal get() {
    if (null == instance) {
      instance = new DecoderBltzal();
    }
    return instance;
  }

  private DecoderBltzal() {
    super(
        32,
        true,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("10000", 2, 5))) {
      return null;
    }
    ...
    return newResult(new bltzal(rs, offset));
  }
}
