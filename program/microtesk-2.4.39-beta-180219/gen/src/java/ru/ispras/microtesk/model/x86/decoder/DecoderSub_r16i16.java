...
import ru.ispras.microtesk.model.x86.op.sub_r16i16;
import ru.ispras.microtesk.model.x86.mode.R16;
import ru.ispras.microtesk.model.x86.mode.IMM16;

/**
 * The {@code DecoderSub_r16i16} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSub_r16i16 extends DecoderItem {
  private static DecoderSub_r16i16 instance = null;

  public static DecoderSub_r16i16 get() {
    if (null == instance) {
      instance = new DecoderSub_r16i16();
    }
    return instance;
  }

  private DecoderSub_r16i16() {
    super(
        32,
        true,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new sub_r16i16(op1, op2));
  }
}
