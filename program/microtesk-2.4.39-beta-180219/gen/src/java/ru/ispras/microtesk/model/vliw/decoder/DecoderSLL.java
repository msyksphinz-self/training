...
import ru.ispras.microtesk.model.vliw.op.SLL;
import ru.ispras.microtesk.model.vliw.mode.R;
import ru.ispras.microtesk.model.Immediate;

/**
 * The {@code DecoderSLL} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderSLL extends DecoderItem {
  private static DecoderSLL instance = null;

  public static DecoderSLL get() {
    if (null == instance) {
      instance = new DecoderSLL();
    }
    return instance;
  }
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    return newResult(new SLL(rd, rt, sa));
  }
}
