...
public final class mov_m8r8 extends IsaPrimitive {
  private static final class Info extends IsaPrimitiveInfoAnd {
    ...
    public IsaPrimitive create(final Map<String, IsaPrimitive> args) {
      ...
      return new mov_m8r8(seg_ovrd, dst, src);
    }
  }
  ...
  public mov_m8r8(final RSEG16 seg_ovrd, final IsaPrimitive dst, final R8 src) {
  ...
  public String image(final TemporaryVariables tempVars) {
    final TempVars vars__ = (TempVars) tempVars;
    init(vars__);
    return String.format("001%s11010001000%s%s%s%s", seg_ovrd.image(vars__), vars__.mod.access().load().toString(), src.image(vars__), vars__.rm.access().load().toString(), dst.image(vars__));
  }
