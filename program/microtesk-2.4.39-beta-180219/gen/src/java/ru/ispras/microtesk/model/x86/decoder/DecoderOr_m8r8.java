...
import ru.ispras.microtesk.model.x86.op.or_m8r8;
import ru.ispras.microtesk.model.x86.mode.RSEG16;
import ru.ispras.microtesk.model.IsaPrimitive;
import ru.ispras.microtesk.model.x86.mode.R8;

/**
 * The {@code DecoderOr_m8r8} class is automatically generated by MicroTESK.
 *
 * @author <a href="mailto:microtesk-support@ispras.ru">MicroTESK</a>
 */
public final class DecoderOr_m8r8 extends DecoderItem {
  private static DecoderOr_m8r8 instance = null;

  public static DecoderOr_m8r8 get() {
    if (null == instance) {
      instance = new DecoderOr_m8r8();
    }
    return instance;
  }

  private DecoderOr_m8r8() {
    super(
        41,
        false,
        null,
  ...
  public DecoderResult decode(final BitVector image) {
    ...
    if (!matchNextOpc(image, BitVector.valueOf("11000001000", 2, 11))) {
      return null;
    }
    ...
    return newResult(new or_m8r8(seg_ovrd, op1, op2));
  }
}
